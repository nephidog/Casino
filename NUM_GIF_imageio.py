...
for i in range(37):
    ...
    for j in range(1,Parts+1):
        Num_Dict[str(i)].append(imageio.imread(f"Roulette_Num_300\\{i}_{Parts}_{j}.PNG"))
...
def CreateNum(Num):
    ...
    # Num_B(Roulette_Box,New_Groove,Num)
    # Num_C(Roulette_Box,New_Groove,Num)
    print("輸出完成")
